...
SELECT a.volume_filtered,a.h_id, a.MIN_GEAR_DEPTH,a.MAX_GEAR_DEPTH, a.gear_name,c.specimen_id,c.sample_volume,b.VOLUME_DISPLACEMENT
    ...
    LOOP
	    ...
	    ELSIF r_company.sample_volume > 0 and r_company.gear_name = 'CTDB'
        	THEN
                ...
                for depthValue in (select depth from vol_filtered_EST_NUM_PERM2 where h_id = r_company.h_id order by depth)
                loop
