...
Added NUMBER_MEASURED_COUNTED =9999 commmand line for biomass calculations - 2016Feb12 by KBahl 
 Added b.MIN_GEAR_DEPTH to table subspecimen_main_geom so that LARVACATCHPER10M2 value can be calculated. - 2016FEB17
...
create table subspecimen_main_geom as select a.preserve_id, a.subsample_id,a.SPECIES_NAME,a.specimen_id,a.LENGTH_VALUE as RAW_VALUE, a.species_code_id,a.stage_id,b.stage_name,a.egg_diameter,a.CORRECTED_LENGTH,a.COMMENTS_SPECIMEN_SUBSAMPLE,b.GEOGRAPHIC_AREA,b.geom,b.gear_abbrev,b.gear_code,b.haul_name,b.haul_id,b.cruise,b.net,b.mesh,b.haul_performance,b.GMT_DATE_TIME,b.lat,b.lon,b.LARVACATCHPER10M2,b.LARVALCATCHPER1000M3,b.PRIMARY_NET,b.STATION_NAME,b.NUMBER_CAUGHT,b.VOLUME_FILTERED,b.MIN_GEAR_DEPTH,b.month,b.year,b.day,b.month_name,b.MAX_GEAR_DEPTH from subspecimen_main_species_view a,specimen_main_geom b where b.specimen_id = a.specimen_id;
