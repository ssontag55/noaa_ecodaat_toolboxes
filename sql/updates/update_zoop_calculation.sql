...
BEGIN
	...
	IF r_company.volume_filtered > 0 
             THEN
        	update specimen
        	set BIO_MASS_PERM3 = BIO_MASS_PERSAMPLE/r_company.volume_filtered,BIO_MASS_PERM2 = BIO_MASS_PERM3*(r_company.MAX_GEAR_DEPTH -r_company.MIN_GEAR_DEPTH) where r_company.specimen_id = specimen_id;
